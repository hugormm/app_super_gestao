    ...
    public function adicionar(Request $request) {
        ...
        if($request->input('_token') != '' && $request->input('id') == '') {
            ...
            $feedback = [
                ...
                'email.email' => 'O campo email nao foi preenchido correctamente'
            ];
            ...
            $msg = 'Registo realizado com sucesso';
        }
        ...
        if($request->input('_token') != '' && $request->input('id') != '') { 
            ...
            return redirect()->route('app.fornecedor.aditar', ['id' => $request->input('id'), 'msg' => $msg]);
        }
